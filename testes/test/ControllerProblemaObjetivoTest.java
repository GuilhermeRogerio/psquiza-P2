...
class ControllerProblemaObjetivoTest {
	...
	private ControllerProblemaObjetivo controllerUs3;

	@BeforeEach
	void setUp() {
		controllerUs3 = new ControllerProblemaObjetivo();

		controllerUs3.cadastraProblema(
		...
		controllerUs3.cadastraProblema("A problematica do aprendizado dos conceitos de programacao orientada a objeto",
				5);
		controllerUs3.cadastraObjetivo("ESPECIFICO",
				...
				4, 5);
		controllerUs3.cadastraObjetivo("GERAL",
	...
	void testCadastraProblemaViabilidadeMenorQue1() {
		assertThrows(IllegalArgumentException.class, () -> this.controllerUs3
	...
	void testCadastraObjetivoTipoNull() {
		assertThrows(NullPointerException.class, () -> this.controllerUs3.cadastraObjetivo(null,
				"Realizar rodas de conversa entre alunos do curso, incluindo especialmente aqueles que emitem mensagens homofobicas e alunos ou pessoas homoafetivas.",
				4, 5));
	}
	...
	void testCadastraObjetivoTipoVazio() {
		assertThrows(IllegalArgumentException.class, () -> this.controllerUs3.cadastraObjetivo(" ",
				"Realizar rodas de conversa entre alunos do curso, incluindo especialmente aqueles que emitem mensagens homofobicas e alunos ou pessoas homoafetivas.",
				4, 5));
	}
	...
	void testCadastraObjetivoDescricaoVazia() {
		assertThrows(IllegalArgumentException.class,
				() -> this.controllerUs3.cadastraObjetivo("ESPECIFICO", " ", 4, 5));
	}

	@Test
	void testCadastraObjetivoAderenciaMenorQue1() {
		assertThrows(IllegalArgumentException.class, () -> this.controllerUs3.cadastraObjetivo("ESPECIFICO",
				"Realizar rodas de conversa entre alunos do curso, incluindo especialmente aqueles que emitem mensagens homofobicas e alunos ou pessoas homoafetivas.",
				0, 5));
	}
	...
	void testExibeProblema() {
		assertEquals("P3 - A problematica do aprendizado dos conceitos de programacao orientada a objeto - 5",
				controllerUs3.exibeProblema("P3"));
	}
	...
	void testExibeObjetivo() {
		assertEquals(
				...
				controllerUs3.exibeObjetivo("O2"));
	}
