...
class ProblemaTest {
	...
	void testContrutorViabilidadeMenorQue1() {
		assertThrows(IllegalArgumentException.class, () -> this.problema = new Problema("A dificuldade da predicao do sistema eleitoral brasileiro", -5));
	}
	
	@Test
	void testContrutorViabilidadeMaiorQue5() {
		assertThrows(IllegalArgumentException.class, () -> this.problema = new Problema("A dificuldade da predicao do sistema eleitoral brasileiro", 10));
	}
	...
	void testToString() {
		...
		assertEquals("A problematica do aprendizado dos conceitos de programacao orientada a objeto - 3", problema.toString());
	}
}
