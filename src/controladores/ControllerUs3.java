...
public class ControllerUs3 {
	...
	public void cadastraProblema(String descricao,int viabilidade) {
		...
		this.validador.validaStringVazia(descricao, "Campo descricao nao pode ser nulo ou vazio.");
		this.validador.validaStringNull(descricao, "Campo descricao nao pode ser nulo ou vazio.");
	...
	public void cadastraObjetivo(String tipo, String descricao,int aderenciaProblema,int viabilidade) {
		...
		this.validador.validaStringVazia(tipo, "Campo tipo nao pode ser nulo ou vazio.");
		this.validador.validaStringNull(tipo, "Campo tipo nao pode ser nulo ou vazio.");
		this.validador.validaStringVazia(descricao, "Campo descricao nao pode ser nulo ou vazio.");
		this.validador.validaStringNull(descricao, "Campo descricao nao pode ser nulo ou vazio.");
	...
	public void apagarProblema(String codigo) {
		this.validador.validaStringVazia(codigo, "Campo codigo nao pode ser nulo ou vazio.");
		this.validador.validaStringNull(codigo, "Campo codigo nao pode ser nulo ou vazio.");
		if(problemas.containsKey(codigo)) {
